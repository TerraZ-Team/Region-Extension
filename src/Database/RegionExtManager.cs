...
namespace RegionExtension.Database
{
    public class RegionExtManager
    {
        ...
        public RegionRequestManager RegionRequestManager => _services?.RequestManager;
        public TriggerManager TriggerManager => _services?.TriggerManager;
        public PropertyManager PropertyManager => _services?.PropertyManager;
        ...
        public RegionExtManager(IDbConnection db, DatabaseRepositoryFactory databaseRepositoryFactory = null, PluginContext context = null)
        {
            ...
            _bootstrapper = new RegionBootstrapper(databaseRepositoryFactory ?? new DatabaseRepositoryFactory(), _context);
        ...
        private bool InitializeDatabase(TerrariaPlugin plugin)
        {
            try
            {
                ...
                _services = _bootstrapper.Initialize(plugin);
